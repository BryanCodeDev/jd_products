          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="text-center group">
              <button
                ...
                className="w-full bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 sm:p-8 hover:bg-white/20 transition-all duration-300 transform hover:scale-105"
              >
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                  <Phone className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                </div>
                <h3 className="text-lg sm:text-xl font-semibold mb-2">WhatsApp</h3>
                <p className="text-blue-100 mb-3 text-sm sm:text-base">Respuesta inmediata</p>
                <p className="text-base sm:text-lg font-medium">+57 323 895 7962</p>
              </button>
            </div>
            ...
            <div className="text-center group">
              <button
                ...
                className="w-full bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 sm:p-8 hover:bg-white/20 transition-all duration-300 transform hover:scale-105"
              >
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-red-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                  <Mail className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                </div>
                <h3 className="text-lg sm:text-xl font-semibold mb-2">Email</h3>
                <p className="text-blue-100 mb-3 text-sm sm:text-base">Consultas detalladas</p>
                <p className="text-sm sm:text-lg font-medium break-all">jdproductos12@gmail.com</p>
              </button>
            </div>
            ...
            <div className="text-center group sm:col-span-2 lg:col-span-1">
              <button
                ...
                className="w-full bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 sm:p-8 hover:bg-white/20 transition-all duration-300 transform hover:scale-105"
              >
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                  <Phone className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                </div>
                <h3 className="text-lg sm:text-xl font-semibold mb-2">Llamada</h3>
                <p className="text-blue-100 mb-3 text-sm sm:text-base">Atención personalizada</p>
                <p className="text-base sm:text-lg font-medium">+57 323 895 7962</p>
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="sm:col-span-2">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 text-blue-400">JD Productos</h3>
              ...
              <div className="flex items-center text-gray-300 text-sm sm:text-base">
                <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 mr-2" />
                <span>Colombia</span>
              </div>
            </div>
            ...
            {/* Productos */}
            <div>
              <h3 className="text-lg sm:text-xl font-semibold mb-4 text-blue-400">Nuestros Productos</h3>
            ...
            {/* Horarios y redes */}
            <div>
              <h3 className="text-lg sm:text-xl font-semibold mb-4 text-blue-400">Síguenos</h3>
              
              {/* Redes sociales */}
              <div className="flex space-x-4 mb-6">
                <button 
                  onClick={() => handleSocialClick('Instagram')}
                  className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300"
                ...
                <button 
                  ...
                  className="w-9 h-9 sm:w-10 sm:h-10 bg-blue-600 rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300"
